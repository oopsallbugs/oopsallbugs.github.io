                ...
                <ul className={styles.experienceList}>
                  <li className={styles.experienceItem}>
                    ...
                    <div className={styles.experienceBody}>
                      ...
                      toolkit components, increasing consistency across the UI.
                      <br />
                      • Independently developed a frontend page for managing
                      users from an external system, owning the full development
                      lifecycle from implementation to testing.
                      <br />
                      • Frontend refactor to separate the single file dashboard
                  ...
                  <li className={styles.experienceItem}>
                    ...
                    <div className={styles.experienceBody}>
                      ...
                      with full CRUD logic for managing tasks. Focused on clean
                      ...
                      <br />
                      • Integrated basic role-based access control and deployed
                      to the cloud.
                ...
                <div className={styles.skillsGrid}>
                  ...
                  <div className={styles.skillCategory}>
                    ...
                    <ul>
                      ...
                      <li>
                        Docker - containerized app environments for consistency
                        and portability.
                      </li>
                      <li>
